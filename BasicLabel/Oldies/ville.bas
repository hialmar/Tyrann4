...
4440 PRINT@4,3;"Car :";C$(CP(P)):PRINT@21,3;"Lev:"NI(P);"EXP:"XP(P)
...
4600 S$="   GIVE:":GOSUB5600:PRINT@1,24;S$
4610 S$="M)oney I)tems Q)uit ":GOSUB5650:PRINT@15,24;S$
4620 GETA$:IF A$<>"M" AND A$<>"I" AND A$<>"Q"THEN4620
4630 IFA$<>"Q"THEN4650
...
5312 L=3:PRINT@3,L;CHR$(145)CHR$(128)"CHARACTER   HOUSE    CAREER   LVL "CHR$(144)
...
5730 GOSUB42000:DO=CH:IFDO> RI(P)THEN PING:GOTO5700
5735 IFDO=0THEN5790
...
5800 S$="Which Item ? 0:None ":GOSUB5600:PRINT@13,24;S$
...
6165 L=2:GOSUB200
6170 PRINT@6,3;" Your choice ";:GOSUB42000
6180 IFCH>NTHEN9000
6190 IFCH=0THEN6070
6195 IFSH=1THENSS=0
...
10800 L=19:PRINT@1,L;CHR$(145)"CHARACTER      CAREER     HP  ST  AC "
...
42000 S$ = ""
42010 GET CH$
42020 IF ASC(CH$) = 13 THEN 42100
42030 IF ASC(CH$) < 48 OR ASC(CH$) > 57 THEN PING:GOTO 42010
42040 PRINT CH$;
42050 S$ = S$ + CH$
42060 GOTO 42010
42100 CH = VAL(S$)
...
49000 TEXT:CLS:PRINT@8,2;CHR$(145);CHR$(135);"++ PREPARING TEAM ++ ";CHR$(144)
...
49600 CLS:PRINT@7,8;".. Loading * Please Wait .."
49610 S$=CHR$(148)+" "+CHR$(144):CU=1:GOTO49650
49620 PRINT@7,8;"++ Saving + Please Wait ++"
