...
temporisation_1
	...
	bne temporisation_2
fin_temporisation	
	jsr wait_key			; scanne les 4 touches flèchées pour scroll et 'Y' pour sortie
	lda $0c
	cmp#$86
	beq sortie_main
...
check_ville_bateau			; la tuile adjacente est la mer
		...
		cmp #$01			
		beq around_sortie		
		cmp #$5e			; si on n'est pas déjçà en mer , est-on dans un port ? Villes portuaires codées entre #$5e et #$63
