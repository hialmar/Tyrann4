...
;	$1a	:	drapeau : on a mot de passe n°1 :1
...
chck_54		; clef_1
		...
		bne around_sortie
chck_61							; ponts   guard ask for laissez-passer
		lda $0a
		cmp #$61				; 
		bne chck_58
		lda $1b
		bne around_sortie		; test:   $1b =1 => on a laissez-passer pont	=> scroll et/ou delplacement autorisés
		jsr  why_no_scoll		
		beq no_scroll			; branchement forcé par sortie sp précédent	
...
chck_57							; mot de passe lu sur colonne
		...
		bne around_sortie
chck_60							; on trouve mot de passe ponts
		lda $0a
		cmp #$60
		bne chck_59
		lda #$01
		sta $1b					; met à 1 drapeau laissez-passer ponts
		bne around_sortie

chck_59							; Legat donne ordre pour fort mur d'Hadrien
		lda $0a
		cmp #$59
		bne chck_55
		lda #$01
		sta $1e					; met à 1 drapeau passage à Londres et lp pour fort mur d'Hadrien
		bne around_sortie
...
init_div_var
	...
	;sta $1e  ci -dessous, à supprimer lorsqu'on pourra atteindre les villes depuis la carte
	sta $1e			; drapeau pass pour centurion donné à Londres
	rts	
;----------------------------------------------------------
...
ponts_guard
	...
	lda $0e
	cmp #$61				; valeur tuile pour garde du port militaire
	beq suite_ponts_guard
	jmp _graffitti
suite_ponts_guard
	ldx #$00
	lda t_ponts_guard_3,x
	sta adr_ecr_txt+1
	lda #<t_ponts_guard_3+1
	sta write_phrase+1
	lda #>t_ponts_guard_3+1
	sta write_phrase+2	
	jsr write_phrase
	...
	ldx #$00
	lda t_ponts_guard_4,x
	sta adr_ecr_txt+1
	lda #<t_ponts_guard_4+1
	sta write_phrase+1
	lda #>t_ponts_guard_4+1
	sta write_phrase+2	
	jsr write_phrase
	...
	ldx #$00
	lda t_ponts_guard_5,x
	sta adr_ecr_txt+1
	lda #<t_ponts_guard_5+1
	sta write_phrase+1
	lda #>t_ponts_guard_5+1
	sta write_phrase+2	
	jsr write_phrase
...
_graffitti
	lda $0e					
	cmp #$60				; valeur tuile lecture graffitti sur mur
	beq suite_graffitti
	jmp _mot_de_passe
suite_graffitti
;	jsr eff_tuile_spe
...
_mot_de_passe
	lda $0e					
	cmp #$57				; valeur tuile lecture graffitti sur mur
	beq suite_mot_de_passe
	jmp garde_
suite_mot_de_passe
;	jsr eff_tuile_spe
	ldx #$00
...
legat_
	lda $0e					
	cmp #$59				; valeur tuile pour legat qui donne laissez-passer
	beq suite_legat
	jmp entrance_	
suite_legat
	jsr eff_tuile_spe	
...
why_no_scoll
		...
		rts
chck_wns_61		
		cmp #$61	; gardien ponts vous n'avez pas le droit de traverser les ponts
		bne chck_wns_58
		jsr ponts_garde_nsc
		rts				
...
ponts_garde_nsc	
	ldx #$00
	lda t_ponts_guard_1,x
	sta adr_ecr_txt+1
	lda #<t_ponts_guard_1+1
	sta write_phrase+1
	lda #>t_ponts_guard_1+1
	sta write_phrase+2	
	jsr write_phrase
	...
	ldx #$00
	lda t_ponts_guard_2,x
	sta adr_ecr_txt+1
	lda #<t_ponts_guard_2+1
	sta write_phrase+1
	lda #>t_ponts_guard_2+1
	sta write_phrase+2	
	jsr write_phrase
...
tab_adr_hires				
	...
	;*******************************************
_L00
	.byt $13,$03,$02,$01,$02,$01,$02,$01,$02,$01,$06,$0e,$1d,$06,$0e,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$06,$0e
_L01
	.byt $05,$00,$00,$00,$00,$00,$00,$00,$00,$00,$0f,$10,$1d,$0f,$03,$02,$01,$02,$01,$02,$01,$02,$01,$02,$01,$02,$01,$03,$46,$40
_L02
	.byt $04,$00,$06,$06,$06,$06,$06,$06,$07,$00,$00,$54,$1d,$1d,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$12
_L03
	.byt $05,$00,$0c,$0b,$0a,$0a,$0a,$0c,$08,$00,$1d,$1d,$1d,$1d,$04,$00,$04,$00,$04,$00,$04,$00,$13,$45,$04,$00,$04,$00,$00,$12
_L04
	.byt $04,$00,$0d,$42,$00,$15,$17,$0c,$08,$00,$1d,$14,$14,$1d,$05,$00,$12,$00,$12,$00,$12,$00,$12,$5f,$12,$00,$12,$00,$00,$12
_L05
	.byt $05,$00,$58,$00,$00,$19,$1b,$0c,$08,$00,$1d,$00,$00,$1d,$00,$00,$05,$00,$05,$00,$05,$00,$05,$00,$05,$00,$05,$00,$00,$12
_L06
	.byt $04,$00,$0c,$07,$00,$00,$59,$0c,$08,$00,$1d,$14,$00,$1d,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$00,$12
_L07
	.byt $12,$00,$06,$06,$06,$06,$06,$06,$08,$00,$62,$00,$00,$1d,$05,$00,$05,$00,$05,$00,$05,$00,$05,$00,$05,$00,$12,$00,$00,$12
_L08
	.byt $13,$02,$0d,$0a,$0a,$0a,$0a,$0a,$42,$00,$1d,$1d,$00,$1d,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$01,$52,$03,$12
_L09
	.byt $05,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$1d,$61,$1d,$12,$00,$05,$00,$05,$00,$05,$00,$05,$00,$05,$00,$04,$00,$00,$12
_L10
	.byt $13,$03,$03,$02,$01,$02,$01,$02,$01,$02,$01,$1d,$53,$03,$11,$00,$00,$00,$00,$00,$04,$00,$00,$00,$00,$00,$12,$00,$00,$12
_L11
	.byt $05,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$61,$00,$00,$00,$00,$06,$06,$06,$06,$06,$06,$06,$07,$01,$03,$11,$00,$00,$12
_L12
	.byt $04,$00,$13,$03,$04,$00,$13,$45,$04,$00,$04,$1d,$04,$00,$00,$00,$0c,$0b,$0a,$0a,$0a,$0a,$0c,$08,$04,$00,$04,$00,$00,$12
_L13
	.byt $05,$63,$12,$00,$12,$00,$12,$5b,$12,$00,$12,$1d,$05,$00,$00,$00,$0c,$08,$00,$00,$00,$00,$0c,$08,$05,$00,$05,$00,$00,$12
_L14
	.byt $13,$03,$11,$00,$05,$00,$12,$00,$12,$00,$05,$1d,$04,$00,$00,$00,$0d,$42,$00,$35,$36,$00,$0c,$08,$04,$00,$04,$00,$06,$3f
_L15
	.byt $05,$00,$00,$00,$13,$03,$11,$00,$13,$02,$1d,$1d,$13,$02,$00,$00,$00,$00,$00,$38,$37,$00,$0c,$08,$05,$00,$12,$00,$0f,$40
_L16
	.byt $04,$00,$04,$00,$05,$00,$00,$00,$05,$00,$1d,$00,$12,$00,$00,$00,$0c,$07,$00,$00,$00,$00,$0c,$08,$04,$00,$05,$00,$00,$12
_L17
	.byt $05,$00,$05,$00,$04,$00,$04,$00,$04,$00,$1d,$00,$05,$00,$04,$00,$0c,$08,$14,$00,$57,$14,$0c,$08,$05,$00,$00,$00,$00,$12
_L18
	.byt $04,$00,$04,$00,$05,$00,$05,$00,$05,$00,$61,$00,$00,$00,$05,$00,$06,$06,$06,$06,$06,$06,$06,$08,$00,$00,$04,$00,$00,$12
_L19
	.byt $05,$00,$05,$00,$04,$00,$04,$00,$04,$00,$1d,$00,$13,$03,$04,$00,$0d,$0a,$0a,$0a,$0a,$0a,$0a,$42,$00,$00,$01,$03,$03,$12
_L20
	.byt $04,$00,$04,$00,$05,$00,$05,$00,$05,$00,$1d,$00,$05,$60,$05,$00,$00,$00,$13,$03,$02,$00,$01,$04,$00,$00,$04,$00,$00,$12
_L21
	.byt $12,$00,$12,$00,$04,$00,$04,$00,$04,$00,$1d,$00,$04,$00,$13,$03,$04,$00,$12,$00,$00,$00,$00,$01,$04,$00,$05,$00,$00,$12
_L22
	.byt $05,$00,$11,$00,$05,$00,$05,$00,$05,$00,$1d,$1d,$05,$00,$05,$00,$05,$00,$12,$00,$04,$00,$00,$00,$12,$00,$00,$00,$00,$12
_L23
	.byt $51,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$1d,$00,$00,$00,$00,$04,$00,$12,$63,$12,$00,$04,$00,$12,$00,$04,$00,$00,$12
_L24
	.byt $04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$1d,$04,$00,$13,$03,$11,$00,$13,$45,$11,$00,$05,$00,$12,$00,$05,$00,$00,$12
_L25
	.byt $12,$00,$05,$00,$05,$00,$05,$00,$05,$00,$05,$1d,$05,$00,$05,$00,$04,$00,$12,$5a,$00,$00,$00,$00,$12,$00,$04,$00,$00,$12
_L26
	.byt $05,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$1d,$1d,$00,$04,$00,$12,$63,$12,$00,$00,$00,$00,$13,$11,$00,$05,$00,$06,$3f
_L27
	.byt $04,$00,$05,$00,$05,$00,$05,$00,$05,$00,$13,$02,$1d,$00,$05,$00,$01,$03,$03,$02,$01,$04,$00,$12,$00,$00,$04,$00,$0f,$40
_L28
	.byt $05,$00,$04,$00,$04,$00,$04,$00,$04,$00,$12,$1d,$1d,$00,$00,$00,$00,$00,$00,$00,$00,$12,$00,$12,$00,$13,$11,$00,$00,$12
_L29
	.byt $04,$00,$13,$03,$11,$00,$13,$02,$01,$02,$01,$02,$1d,$00,$01,$02,$00,$13,$02,$01,$03,$11,$00,$12,$00,$05,$00,$00,$13,$11
_L30
	.byt $05,$00,$05,$00,$00,$00,$12,$00,$00,$00,$00,$1d,$1d,$00,$00,$00,$00,$05,$00,$00,$00,$00,$00,$12,$00,$04,$00,$00,$12,$20
_L31
	.byt $04,$00,$04,$00,$13,$03,$12,$00,$13,$03,$04,$1d,$13,$45,$04,$00,$00,$00,$00,$01,$04,$00,$13,$03,$03,$11,$00,$13,$11,$20
_L32
	.byt $05,$00,$05,$00,$12,$00,$05,$00,$12,$00,$12,$1d,$12,$5c,$12,$00,$55,$04,$00,$00,$12,$00,$12,$00,$00,$00,$00,$12,$20,$20
_L33
	.byt $04,$00,$04,$00,$05,$00,$00,$00,$05,$00,$05,$1d,$12,$00,$01,$03,$03,$03,$02,$01,$11,$00,$12,$00,$04,$00,$13,$11,$20,$20
_L34
	.byt $13,$45,$11,$00,$04,$00,$04,$00,$04,$00,$04,$1d,$12,$00,$00,$00,$00,$00,$00,$00,$00,$00,$12,$00,$05,$00,$12,$20,$20,$20
_L35
	.byt $12,$5e,$00,$00,$05,$00,$05,$00,$05,$00,$05,$1d,$01,$03,$02,$00,$01,$02,$00,$00,$00,$01,$11,$00,$00,$13,$11,$20,$20,$20
_L36
	.byt $05,$00,$00,$00,$00,$00,$04,$00,$00,$00,$00,$62,$00,$00,$00,$00,$00,$00,$00,$06,$0e,$00,$00,$00,$06,$3f,$20,$20,$20,$20
_L37
	.byt $04,$00,$06,$0e,$00,$00,$05,$00,$00,$00,$00,$1d,$1d,$00,$00,$00,$00,$13,$03,$46,$03,$02,$00,$01,$46,$10,$20,$20,$20,$20
_L38
	.byt $01,$03,$46,$03,$03,$02,$01,$02,$01,$02,$01,$02,$1d,$01,$03,$03,$03,$11,$1d,$1d,$1d,$1d,$61,$1d,$1d,$20,$20,$20,$20,$20
_L39
	.byt $1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$62,$1d,$1d,$1d,$1d,$1d,$1d,$1d
_L40
	.byt $1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$1d,$00,$00,$00,$00,$00,$1d,$1d,$1d,$1d,$1d
_L41
	.byt $20,$13,$02,$01,$02,$01,$02,$01,$02,$01,$02,$1d,$1d,$1d,$20,$00,$20,$20,$20,$20,$20,$00,$00,$20,$00,$20,$20,$20,$20,$20
_L42
	.byt $20,$12,$63,$00,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$00,$00,$00,$00,$00,$20,$20,$20,$20,$00,$20,$20,$20,$63,$20
_L43
	.byt $20,$01,$02,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$20,$20,$20,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$20
_L44
	.byt $20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20
...
t_ponts_guard_1
	.byt $98
	.asc "The guard said 'Quo vadis?",0
t_ponts_guard_2	
	.byt $be	
...
t_ponts_guard_4	
	.byt $c2	
	.asc "You say 'Ad fatum meum'",0
t_ponts_guard_5	
	.byt $99	
	.asc "the guard lets you cross.",0	
	
; ------------------------------------	
	
t_graffitti_1
	.byt $96
	.asc "You can see a graff on the wall",0
t_graffitti_2	
	.byt $C2	
	.asc "It reads 'ad fatum meum'.",0
	
; ------------------------------------	
	
t_m_de_passe_1
	.byt $94
	.asc "Someone dropped a piece of paper",0
t_m_de_passe_2	
	.byt $bb	
	.asc "on the ground.It reads 'alio mores'",0	
; ------------------------------------
t_garde_1
	.byt $98
	.asc "A guard says 'Aliam vitam'",0
t_garde_2
	.byt $bd
	.asc "And is waiting for your answer.",0
t_garde_3
...
t_legat_2
	.byt $bf	
	.asc "the legate gives you a pass",0
t_legat_3
	.byt $93	
	.asc "to the centurion of Fort Borcovicus",0	
; ------------------------------------	
t_entrance_1
	.byt $99	
...
dta_bandeau		
	...
	.byt $00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$00,$04,$00,$04,$00,$03,$40,$70,$00,$04,$00,$04,$00,$04,$03,$41,$00,$03,$50,$00,$04,$00,$04,$00,$04,$03,$40,$70,$00,$04,$00,$04,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$00,$04,$00,$04,$07,$40,$43,$7C,$00,$04,$00,$04,$00,$03,$40,$43,$4E,$4F,$5C,$00,$04,$00,$04,$00,$07,$40,$43,$7C,$00,$04,$00,$04,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$00,$04,$00,$04,$40,$03,$7F,$6F,$70,$00,$04,$00,$04,$03,$40,$55,$7E,$47,$7D,$00,$04,$00,$04,$00,$7F,$03,$7F,$6F,$70,$00,$04,$00,$04,$00,$04,$0
	.byt $00,$04,$00,$04,$00,$04,$00,$07,$40,$43,$7E,$53,$7C,$00,$04,$00,$04,$03,$40,$75,$78,$43,$7F,$60,$00,$04,$00,$07,$40,$43,$7E,$53,$7C,$00,$04,$00,$04,$00,$04,$0
	.byt $00,$04,$00,$04,$00,$04,$00,$03,$40,$4F,$79,$7C,$13,$10,$00,$04,$00,$03,$40,$6F,$40,$40,$5F,$50,$00,$04,$00,$03,$40,$4F,$79,$7C,$13,$10,$00,$04,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$00,$04,$00,$7F,$07,$7F,$67,$7F,$4F,$70,$00,$04,$03,$40,$45,$5F,$70,$41,$7F,$54,$00,$04,$00,$7F,$07,$7F,$67,$7F,$4F,$70,$00,$04,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$00,$04,$03,$40,$4F,$7E,$5F,$7F,$73,$13,$10,$00,$03,$40,$45,$7C,$40,$40,$47,$7C,$00,$04,$03,$40,$4F,$7E,$5F,$7F,$73,$13,$10,$00,$04,$00,$04,$0
	.byt $00,$04,$00,$04,$00,$04,$40,$07,$7F,$79,$7F,$7F,$7C,$7F,$70,$00,$03,$40,$4E,$7F,$40,$40,$5F,$7A,$00,$04,$40,$07,$7F,$79,$7F,$7F,$7C,$7F,$70,$00,$04,$00,$04,$0
	.byt $00,$04,$00,$04,$00,$03,$40,$43,$7F,$67,$7F,$7F,$7F,$4F,$7C,$00,$03,$40,$4F,$7C,$40,$40,$43,$5A,$00,$03,$40,$43,$7F,$67,$7F,$7F,$7F,$4F,$7C,$00,$04,$00,$04,$0
	.byt $00,$04,$00,$04,$00,$07,$40,$4F,$7E,$48,$73,$4C,$72,$67,$80,$04,$03,$40,$6F,$60,$40,$40,$43,$76,$60,$07,$40,$4F,$7E,$48,$73,$4C,$72,$67,$80,$04,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$03,$40,$43,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7E,$40,$40,$77,$70,$40,$40,$41,$7E,$60,$40,$43,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7C,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$07,$40,$4F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$80,$84,$03,$40,$7D,$40,$40,$40,$40,$4B,$60,$07,$4F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$80,$84,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$00,$03,$40,$7B,$60,$40,$40,$40,$7B,$60,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$00,$04,$00,$04,$0
	.byt $00,$04,$00,$07,$40,$43,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$78,$04,$FF,$40,$40,$40,$03,$5E,$07,$43,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$78,$00,$04,$0
	.byt $00,$04,$00,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$04,$03,$43,$5E,$40,$40,$40,$40,$4E,$68,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$00,$04,$00,$04,$0
	.byt $00,$04,$00,$04,$07,$40,$4F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7E,$03,$43,$50,$40,$40,$40,$40,$51,$78,$07,$4F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7E,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$03,$43,$7F,$40,$40,$40,$40,$4F,$78,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$03,$40,$4F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7E,$40,$41,$7E,$40,$40,$40,$40,$4F,$70,$40,$4F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7E,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$07,$40,$43,$78,$5F,$61,$7E,$4F,$70,$7B,$43,$78,$40,$03,$7C,$40,$40,$40,$40,$43,$70,$07,$43,$78,$5F,$61,$7E,$4F,$70,$7B,$43,$78,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$03,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$46,$66,$40,$40,$40,$40,$4C,$6C,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$07,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$03,$47,$6E,$40,$40,$40,$40,$4E,$7C,$07,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$03,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$43,$7C,$40,$40,$40,$40,$47,$78,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$07,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$03,$41,$79,$60,$40,$40,$40,$53,$70,$07,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$03,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$46,$57,$40,$40,$40,$40,$5D,$6E,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$07,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$03,$47,$7E,$50,$40,$40,$40,$6F,$7C,$07,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$03,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$43,$7F,$60,$40,$40,$40,$7F,$78,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$00,$04,$00,$4
	.byt $00,$04,$00,$04,$07,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$03,$5B,$60,$40,$40,$40,$7F,$40,$07,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$00,$04,$0
	.byt $00,$04,$00,$04,$03,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$41,$7F,$50,$40,$40,$41,$7F,$70,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$00,$04,$0
	.byt $00,$04,$00,$04,$07,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$03,$47,$7E,$74,$40,$40,$45,$67,$7C,$07,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$00,$04,$0
	.byt $00,$04,$00,$04,$03,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$41,$77,$7C,$40,$40,$47,$75,$70,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$00,$04,$0
	.byt $00,$04,$00,$04,$07,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$03,$4F,$6D,$40,$40,$56,$7E,$40,$07,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$00,$04,$0
	.byt $00,$04,$00,$04,$07,$03,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$40,$7F,$4D,$40,$40,$57,$5F,$70,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$00,$04,$0
	.byt $00,$04,$00,$04,$07,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$04,$13,$00,$5F,$7F,$64,$48,$5F,$97,$7E,$6F,$72,$7F,$4B,$79,$5F,$65,$7E,$6F,$7F,$84,$80,$84
	.byt $00,$04,$00,$04,$03,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$40,$41,$7B,$60,$40,$7B,$70,$40,$40,$41,$50,$4D,$40,$74,$46,$60,$5A,$41,$50,$40,$00,$04,$0
	.byt $00,$04,$00,$04,$07,$40,$4F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$40,$03,$47,$7F,$60,$40,$5F,$7C,$40,$07,$4F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$40,$00,$04,$0
	.byt $00,$04,$00,$04,$03,$40,$4F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$40,$40,$4F,$67,$40,$40,$5C,$7E,$40,$40,$4F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$40,$00,$04,$0
	.byt $00,$04,$00,$04,$07,$40,$60,$40,$40,$40,$40,$40,$40,$40,$40,$40,$50,$40,$03,$5F,$78,$43,$7F,$40,$40,$07,$60,$40,$40,$40,$40,$40,$40,$40,$40,$40,$50,$00,$04,$0
	.byt $00,$04,$00,$04,$40,$40,$C0,$C0,$C0,$C0,$C0,$C0,$C0,$C0,$C0,$87,$70,$40,$03,$7E,$5F,$7F,$47,$60,$40,$40,$C0,$C0,$C0,$C0,$C0,$C0,$C0,$C0,$C0,$87,$70,$00,$04,$0
	.byt $00,$04,$00,$07,$40,$44,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$44,$40,$03,$43,$78,$43,$78,$40,$07,$44,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$44,$00,$04,$0
	.byt $00,$04,$00,$07,$40,$47,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7C,$40,$03,$4E,$40,$40,$4E,$40,$07,$47,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7C,$00,$04,$0
	.byt $00,$04,$00,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$7F,$03,$48,$40,$40,$42,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$40,$00,$04,$00,$0a
;--------------------------------------------------	
dta_nom_ville

	.byt $1,$40,$40,$40,$40,$40,$40,$41,$73,$60,$40,$4E,$40,$40,$40,$40,$40
	.byt $1,$43,$60,$40,$40,$40,$40,$41,$73,$60,$40,$4E,$40,$40,$40,$40,$40
	.byt $1,$43,$60,$40,$40,$40,$40,$41,$73,$60,$40,$4E,$40,$40,$40,$40,$40
	.byt $1,$43,$60,$40,$40,$40,$40,$41,$70,$40,$40,$40,$40,$40,$40,$40,$40
	.byt $1,$43,$60,$43,$78,$7B,$70,$5D,$73,$67,$5E,$4E,$5C,$5C,$7B,$73,$70
	.byt $1,$43,$60,$4F,$7C,$7F,$78,$7F,$73,$67,$7F,$4E,$5C,$5C,$7F,$7F,$78
	.byt $1,$43,$60,$4E,$5E,$7C,$79,$7B,$73,$67,$67,$4E,$5C,$5C,$7C,$7C,$78
	.byt $1,$43,$60,$5C,$4E,$78,$79,$71,$73,$67,$47,$4E,$5C,$5C,$78,$78,$78
	.byt $1,$43,$60,$5C,$4E,$78,$79,$71,$73,$67,$47,$4E,$5C,$5C,$78,$78,$78
	.byt $1,$43,$60,$5C,$4E,$78,$79,$71,$73,$67,$47,$4E,$5C,$5C,$78,$78,$78
	.byt $1,$43,$60,$5C,$4E,$78,$79,$71,$73,$67,$47,$4E,$5C,$5C,$78,$78,$78
	.byt $1,$43,$60,$5E,$5C,$78,$79,$7B,$73,$67,$47,$4E,$5C,$7C,$78,$78,$78
	.byt $1,$43,$7E,$4F,$7C,$78,$78,$7F,$73,$67,$47,$4E,$5F,$7C,$78,$78,$78
	.byt $1,$43,$7E,$47,$70,$78,$78,$5D,$73,$67,$47,$4E,$4F,$5C,$78,$78,$78