...
%OSDK%\bin\tap2dsk -n"   Tyrann III" -i"DIR" BUILD\combat.tap BUILD\camp.tap BUILD\ville.tap BUILD\dialog.tap BUILD\cpzerop.tap BUILD\map.tap BUILD\ville1.tap t4_prog.dsk
