...
5730 GOSUB 42000:DO=CH:IF DO> RI(P) THEN PING:GOTO 5700
...
6165 L=2:GOSUB200
6170 PRINT@6,3;" Que desirez vous acheter ";:GOSUB42000
6180 IFCH>NTHEN9000
6190 IFCH=0THEN6070
6195 IFSH=1THENSS=0
...
8700 IFWR(P)=0ANDWL(P)=0ANDPT(P)=0ANDSA(P,1)=0ANDBT(P)=0THENS$=" ! VIDE ! ":GOSUB5650:PRINT@20,17;S$:ZAP:WAIT80:RETURN
8720 PING:S$="LEQUEL ? ":GOSUB5650:PRINT@5,23;S$
...
48331 O1=O1+1:OUT=PEEK(O1)::GOSUB49650
48350 RETURN
...
49380 O1=O1+1:POKEO1,NP:GOSUB49650
49385 O1=O1+1:POKEO1,NF
49386 O1=O1+1:POKEO1,PM::
49387 O1=O1+1:POKEO1,OUT::GOSUB49650
