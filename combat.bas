...
7070 IF A$="1" THEN RELEASE : GOTO 20305
7080 CLS:PRINT@15,5;"Pleutre !":ZAP
7090 PRINT@5,8;"Memoire restante:";:PRINT FRE(""):PING:RELEASE:END 

8000 REM |SOUS PROGS COMBAT 

8100 REM AFFICHE ENNEMIS
8105 REM ZO=1'DEV A VIRER
8110 FORI=1TO6:PRINT@1,I;"                               ":NEXT
8115 REM PRINT@3,6;"DC:";DC;"EV:";EV
8120 FORI=1TONE
...
20300 GOSUB 49000
20305 PRINT OUT
20310 IF OUT=1 THEN LOAD("MAP") ELSE LOAD("LABY")
...
21040 S$="Et gagne qqs PV !":L=13:GOSUB 300:WAITTI*8
21045 S$=" 1   2   3   4   5   6"
21046 PLOT 7,15,S$
...
48326 O1=O1+1:OUT=PEEK(O1):GOSUB49650:REM PRINT "OUT";OUT
48349 REM IF KEY$<> " " THEN 48349
48350 RETURN
